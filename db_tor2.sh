...
echo "(STARTING) NOTICE: Tor is not the only one connecting, by default; all address connected to the server at FCF7E52010F2F91E37C8DE632E4B7F02878075D1 are not fully owned by Tor"
sleep 3
...
echo So, Target name is $target_name. Targets Age is $age_, and hes currently located at $country_
